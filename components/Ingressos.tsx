    ...
    <section ref={sectionRef} id="ingressos" className="ingressos-section"
      ...
      <div className="ticket-card" style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.55)", marginTop: "8px", marginBottom: "8px" }}>
            +55 11 98468-7528
          </p>
          <a
            href="https://wa.me/5511984687528?text=Ol%C3%A1%2C+quero+garantir+meu+ingresso+para+o+Colmeia!"
            target="_blank"
